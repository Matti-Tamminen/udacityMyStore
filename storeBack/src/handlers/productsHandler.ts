...
const createOne = async (req: Request, res: Response) => {
	...
	try {
		...
		const result = await products.createOneProduct(name as ProductType['name'], description as ProductType['description'], price as ProductType['price'], url as ProductType['url'])
...
export const productRoutes = (app: express.Application): void => {
	...
	app.delete('/products/delete/:id', deleteOne)
